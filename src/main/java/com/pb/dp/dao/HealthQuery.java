...
public interface HealthQuery {
	...
	String GET_CUST_HEALTH = "select c.id as customerId,c.mobile,h.firstName,h.middleName,h.lastName,h.dob,mr.name as relationship,h.email " +
			"as emailId ,h.gender,h.id as healthdbId,h.healthId,h.healtIdNo,a2.line1 as address,a2.stateId,a2.districtId,a2.pincode,ms.ndhm_name as state,md.ndhm_name as district," +
